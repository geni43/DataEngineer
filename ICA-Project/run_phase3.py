...
if __name__ == '__main__':
    ...
    print datetime.now()
    print 'Content File: %s' % args.content_file
    print 'Cites File: %s' % args.cites_file
    print 'Aggregator: %s' %args.aggregate
    print 'Directed : %s' %args.directed
    print 'dont use node attributes: %s' %args.dont_use_node_attributes
    ...
    print datetime.now()
        #print str(np.mean(ica_accuracies[b]))
